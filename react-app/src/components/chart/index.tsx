...
class CryptoChart extends React.Component<any, any> {
    ...
    async componentDidMount() {
        ...
        let xVal: any = Object.keys(data.bpi).map(date => {
            return {
                date,
                price: data.bpi[date],
            };
    ...
    render() {
        ...
        const { classes, hideTooltip, tooltipData, tooltipTop, tooltipLeft } = this.props;
...
export default withStyles(styles, { withTheme: true })(withTooltip(CryptoChart));